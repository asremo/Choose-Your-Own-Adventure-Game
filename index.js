...
if (firstAnswer === 'right'){
    ...
    if (secondAnswer === 'past the dragon'){
        let thirdAnswer = window.prompt('The dragon wakes up and sits upgright. You only have a moment to respond, to stay or run?')
        if (thirdAnswer === 'stay'){
            window.alert('You and the dragon have an uplifting conversation about politics and become lifelong friends.')
        }
